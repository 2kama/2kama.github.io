...
'use strict';
    ...
    // Initialize Firebase
    var config = {
        apiKey: "AIzaSyBEIfkj31A4026027KLiMSaqaqY3bUSpAA",
        authDomain: "mishsites.firebaseapp.com",
        databaseURL: "https://mishsites.firebaseio.com",
        projectId: "mishsites",
        storageBucket: "mishsites.appspot.com",
        messagingSenderId: "389843861160"
      };
        ...
        Component: {
            ...
            forms: function(){
                ...
                if($contactForm.length>0) {
                    ...
                    $contactForm.submit(function(e) {
                        ...
                        $('.takeForm').html("Submitting");



                        db.collection("contactForm").doc("t" + timestamp).set({
                            name : name,
                            email : email,
                            msg : msg
                        }).then(function() {
                            $('.takeForm').html("Thanks for the message. I promise to get back to you ASAP.");

                            setTimeout(function() {
                                $('.takeForm').html("Send message!");
                                $('.hisName').val("");
                                $('.hisEmail').val("");
                                $('.hisMsg').val("");
                            }, 4000);
                        }).catch(function(error) {
                            $('.takeForm').html("Something went wrong! Try Again!");
            ...
            map: function() {
                ...
                if($googleMap.length) {
                    ...
                    var yourLatitude = 39.9602166;   
                    var yourLongitude = -75.6231406;    
